...
def configure(build_type):
    with (SCRIPTS_DIR.parent / "build.ninja").open("w") as f:
        ...
        writer.variable(
            "cl_common_flags",
            "/MT /EHsc /Gs /DNDEBUG /Zi /I $builddir/autogenerated /I src /I 3rdparty/munit /I 3rdparty/Detours/src",
        )
        writer.variable("cl_flags", "$cl_common_flags /Od /Oi /Ob0 /Gr /Gy")
        writer.variable("cl_flags_pbg", "$cl_common_flags /Od /Oi /Ob0 /Gr /Gy")
        writer.variable(
            "cl_flags_detours",
        ...
        writer.build(
            ...
            inputs=[
                "$builddir/" + x + ".obj"
                for x in (cxx_sources + pbg_sources + ["stubs"])
            ],
        ...
        objfiles = (
            ...
            + ["$builddir/th08.res", "$builddir/stubs.obj"]
        )
        if build_type in [BuildType.DIFFBUILD, BuildType.DLLBUILD]:
